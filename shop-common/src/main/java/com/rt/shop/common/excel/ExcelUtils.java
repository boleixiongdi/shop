package com.rt.shop.common.excel;
...
import com.rt.shop.common.excel.template.PoiTemplate;
import com.rt.shop.common.excel.template.utils.PoiUtil;
import com.rt.shop.common.tools.FileUtils;
...
//	public static void exportOrderExcel(HttpServletResponse response,
//			String fileName, List<OrderForm> data, Map titleMap) throws Exception {
//		ByteArrayOutputStream os = new ByteArrayOutputStream();
//		PoiUtil.writeOrderExcel(data, os, titleMap);
//		os.flush();
//		byte[] buf = os.toByteArray();
//		InputStream is = new ByteArrayInputStream(buf, 0, buf.length);
//		FileUtils.downloadFile(response, is, fileName);

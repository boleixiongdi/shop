package com.rt.shop.common.constant;

import com.rt.shop.common.tools.PropertyUtil;
...
public class CacheConstans {
	...
	public static final String SYSCONFIG_CACHE = "SysConfig";
	public static final int SYSCONFIG_CACHE_TIME=36000;//10小时

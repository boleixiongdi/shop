...
import org.springframework.web.multipart.commons.CommonsMultipartFile;
 ...
 public class CommUtil
 {
   ...
   public static String  isMobileDeviceValue(String requestHeader){
       /**
        * android : 所有android设备
        * mac os : iphone ipad
        * windows phone:Nokia等windows系统的手机
...
//       encoder.encode(bimage, param);
   ...
   public static String exactSetToString(Set set){
	   String x = "";
	   for(Object str : set){
			x+=str+",";
		}
   ...
   public static String exactListToString(List list){
	   String x = "";
	   for(Object str : list){
			x+=str+",";
		}

...
import com.rt.shop.query.support.IQueryObject;
  ...
  implements IQueryObject
{
  ...
  public QueryObject(String currentPage, ModelAndView mv, String orderBy, String orderType)
  {
    if ((currentPage != null) && (!currentPage.equals("")))
      setCurrentPage(Integer.valueOf(this.null2Int(currentPage)));
   ...
   * @param orderType
   */
  public QueryObject(ModelAndView mv, String orderBy, String orderType)
  {

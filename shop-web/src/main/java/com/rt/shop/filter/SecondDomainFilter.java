  ...
  implements Filter
{
  ...
  @Autowired(required=false)
  private ISysConfigService configServiceImpl;
    ...
    throws IOException, ServletException
  {
    ...
    if (this.configServiceImpl.getSysConfig().getSecond_domain_open())
    {
      ...
      if (cookies != null) {
        ...
        User user = this.userServiceImpl.selectById(CommUtil.null2Long(id));
        if (user != null)

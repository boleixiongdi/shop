...
<div class="swiper-slide">
    ...
    <section class="contact">
    	<div class="box">
        	<div class="above">
            	<div class="wechat"><img src="${ctxPath!}/static/gw/Picture/zscat_weixin.jpg" alt="扫描关注zsCat微信公众账号" /></div>
                <div class="left">
    ...
    <div class="dock">
        <ul class="icons">
            ...
            <li class="wechat">
            	<i></i><p><img src="${ctxPath!}/static/gw/Picture/zscat_weixin.jpg" alt="扫描关注网站建设微信公众账号" /></p>
            </li>

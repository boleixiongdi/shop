...
function myfriend_post(uid) {
	if($('friend_'+uid)) {
		$('friend_'+uid).innerHTML = '<p>���������Ǻ����ˣ�������������ԣ�<a href="home.php?mod=space&do=wall&uid='+uid+'" class="xi2" target="_blank">��TA����</a> ������ <a href="home.php?mod=spacecp&ac=poke&op=send&uid='+uid+'&handlekey=propokehk_'+uid+'" id="a_poke_'+uid+'" class="xi2" onclick="showWindow(this.id, this.href, \'get\', 0, {\'ctrlid\':this.id,\'pos\':\'13\'});">����к�</a></p>';
	}
	showCreditPrompt();
}

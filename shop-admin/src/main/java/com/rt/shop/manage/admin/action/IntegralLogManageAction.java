...
import com.rt.shop.entity.query.IntegralLogQueryObject;
   ...
   public ModelAndView list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType, String userName)
   {
     ...
     if ((userName != null) && (!userName.equals("")))
       qo.addQuery("obj.integral_user.userName", 
         new SysMap("userName", 
         userName), "=");
     Page pList = this.integrallogService.selectPage(new Page<IntegralLog>(Integer.valueOf(CommUtil.null2Int(currentPage)), 12), null);
